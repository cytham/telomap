...
def main():
    ...
    # Run Telomap
    out = TeloMap(args.mode, args.reads, args.capoligo, args.barcodes, args.threads, args.name, args.motif, args.oligoscore, args.barscore, args.gapopen, args.gapextend, tsv_header=True)
